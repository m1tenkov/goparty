...
def format_profile_text(name, age, city, games_text, microphone_text, about, include_review=False, microphone_emoji=None):
    text = texts.TEMPLATE_PROFILE_TEXT.format(
        ...
        emoji_microphone=microphone_emoji or texts.EMOJI_MICROPHONE_ON,
